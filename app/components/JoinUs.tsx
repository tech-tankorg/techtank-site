        ...
        <div className="flex flex-wrap justify-center gap-8 mt-10 flex-col items-center lg:gap-24 md:gap-16 sm:gap-12 sm:flex-row sm:items-center">
          <div className={SharedStyles.card}>
            ...
            >
              ...
              />
              <h3 className={SharedStyles.cardHeader}>Slack</h3>
              <p className={SharedStyles.cardBody}>
          ...
          <div className={SharedStyles.card}>
            ...
            >
              <Image
                ...
                className={SharedStyles.img}
              />
              <h3 className={SharedStyles.cardHeader}>Meetup</h3>
              <p className={SharedStyles.cardBody}>
          ...
          <div className={SharedStyles.card}>
            ...
            >
              <Image
                ...
                className={SharedStyles.img}
              />
              <h3 className={SharedStyles.cardHeader}>Luma</h3>
              <p className={SharedStyles.cardBody}>
          ...
          <div className={SharedStyles.card}>
            ...
            >
              <Image
                ...
                className={SharedStyles.img}
              />
              <h3 className={SharedStyles.cardHeader}>Github</h3>
              <p className={SharedStyles.cardBody}>
          ...
          <div className={SharedStyles.card}>
            ...
            >
              <Image
                ...
                className={SharedStyles.img}
              />
              <h3 className={SharedStyles.cardHeader}>LinkedIn</h3>
              <p className={SharedStyles.cardBody}>
          ...
          <div className={SharedStyles.card}>
            ...
            >
              <Image
                ...
                className={SharedStyles.img}
              />
              <h3 className={SharedStyles.cardHeader}>Instagram</h3>
              <p className={SharedStyles.cardBody}>
